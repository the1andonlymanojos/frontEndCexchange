...
export default function ImageCar({images, className, height}:{
    ...
    return <div className={`${className}`}>
        <div className="mb-2 bg-white w-full max-h-[500px] aspect-square max-w-full overflow-hidden">
            <img className="w-full h-full object-contain"  src={images[currentImage]}/>
        </div>
